...
const GsButton = (item) => {
  ...
  const handleScroll = () => {
    const scrollTarget = window.innerHeight / 2 + 140;
    const duration = 1200;
    const startTime = performance.now();
    const startPosition = window.screenTop;
    ...
    const smoothScroll = (currentTime) => {
      ...
      window.scrollTo(0, startPosition + scrollTarget * ease);
  ...
  return (
    <StyledWrapper>
      <button onClick={handleScroll} className="mt-6 text-white">
        {item}
